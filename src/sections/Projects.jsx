...
// 🌟 কার্ডগুলোর জন্য প্রিমিয়াম ৩D/অ্যাঙ্গেল অ্যানিমেশন ভ্যারিয়েন্ট
const cardVariants = {
  hidden: { 
    opacity: 0, 
    y: 30, 
    rotateX: 15,    // হালকা ৩D টিল্ট অ্যাঙ্গেল
    scale: 0.95 
  },
  visible: (index) => ({
    opacity: 1, 
    ...
    transition: { 
      ...
      stiffness: 100,
      damping: 15,
      delay: index * 0.08, // ⚡ একটির পর আরেকটি কার্ড স্টাইলিশভাবে আসার জন্য ডিলে
    }
  }),
  exit: { 
    opacity: 0, 
...
const Projects = () => {
  ...
  return (
    <section id="projects" className="py-20 bg-transparent border-t border-slate-800/50 relative z-10 [perspective:1000px]">
      <div className="container mx-auto px-6 md:px-12">
        ...
        {isLoading ? (
          ...
          <motion.div layout className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* 💡 mode="popLayout" দেওয়ার কারণে কার্ডগুলো ডিলিট/চেঞ্জ হওয়ার সময় লেআউট ঝটকা খাবে না */}
            <AnimatePresence mode="popLayout">
              {displayedProjects.map((project, index) => (
                <motion.div
                  key={project._id}
                  layout
                  custom={index} // ইন্ডেক্স পাস করা হয়েছে স্ট্যাগার ইফেক্টের জন্য
                  variants={cardVariants}
                  initial="hidden"
                  animate="visible"
                  exit="exit"
                  className="relative p-[1px] rounded-2xl overflow-hidden group hover:shadow-[0_0_20px_rgba(6,182,212,0.3)] transition-all duration-300 origin-center"
                >
